...
//                                    ^ source.vala meta.class.body.vala meta.block.vala meta.block.vala punctuation.section.block.begin.vala
        stdout.printf ("ok");
//      ^^^^^^ source.vala meta.class.body.vala meta.block.vala variable.other.vala
    }
